BUTTINGS = {
	...
	GOLD_GAIN_PERCENTAGE = 150,         -- (default = 100) factor for gold income
	GOLD_PER_MINUTE = 180,               -- (default =  90) passive gold
	RESPAWN_TIME_PERCENTAGE = 70,      -- (default = 100) factor for respawn time
	XP_GAIN_PERCENTAGE = 150,           -- (default = 100) factor for xp income
	...
	XP_PER_MINUTE = 200,                -- (normal dota = 0) everyone gets passive experience (like the passive gold)
	...
	BUYBACK_LIMIT = 2,                  -- Max amount of buybacks
