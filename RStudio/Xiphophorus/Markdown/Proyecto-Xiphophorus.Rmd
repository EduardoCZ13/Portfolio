...
---
<body style="background-color:57d7d9ff;">
...
```{r}
geodata_path("~/Portfolio/RStudio/Xiphophorus/Markdown")
...
Bioclimexp<-c(BIO1 = "Annual Mean Temperature", BIO2 = "Mean Diurnal Range (Mean of monthly (max temp - min temp))", BIO3 = "Isothermality (BIO2/BIO7) (×100)",
              ...
              BIO16 = "Precipitation of Wettest Quarter", BIO17 = "Precipitation of Driest Quarter", BIO18 = "Precipitation of Warmest Quarter",
...
corrplot(cormatriz, outline = TRUE, tl.col = "black", mar = c(2,0,1,1.5), title = get(especiecurrent)[1,1]) 
...
mtext("Test de equivalencia X. birchmani", side = 3, line = -1.5, outer = TRUE)

```
En el primer caso, de comparación de la especie *X. birchmani* contra el resto de las especies, observamos un valor de D relativamente bajos, lo que nos indicaría poco sobrelape entre las ocurrencias de esta especie comparada con las demás. Sin embargo, los valores de P son muy elevados, lo que significa que los nichos no son más diferentes que por azar. Esto ¿qué significa? Que aunque no existe mucho sobrelape entre las nubes de puntos de ocurrencias (inciso 3.2), los valores predichos para cada una de las especies no son muy diferentes entre si. Lo cual no nos permite descartar la posibilidad de que sus nichos sean diferentes. 
...
mtext("Test de equivalencia X. cortezi", side = 3, line = -1.5, outer = TRUE)
...
mtext("Test de equivalencia X. malinche", side = 3, line = -1.5, outer = TRUE)
...
mtext("Test de equivalencia X. multilineatus", side = 3, line = -1.5, outer = TRUE)
...
mtext("Test de equivalencia X. nezahualcoyotl", side = 3, line = -1.5, outer = TRUE)
...
mtext("Test de equivalencia X. nigrensis", side = 3, line = -1.5, outer = TRUE)
...
mtext("Test de equivalencia X. pygmaeus", side = 3, line = -1.5, outer = TRUE)
...
mtext("Test de similaridad X. birchmani", side = 3,  line = -1.5, outer = TRUE)
...
mtext("Test de similaridad X. cortezi", side = 3,  line = -1.5, outer = TRUE)
...
mtext("Test de similaridad X. malinche", side = 3,  line = -1.5, outer = TRUE)
...
mtext("Test de similaridad X. multilineatus", side = 3,  line = -1.5, outer = TRUE)
...
mtext("Test de similaridad X. nezahualcoyotl", side = 3,  line = -1.5, outer = TRUE)
...
mtext("Test de similaridad X. nigrensis", side = 3,  line = -1.5, outer = TRUE)
```
####3.5.7 *X. pygmaeus*
```{r}
...
mtext("Test de similaridad X. pygmaeus", side = 3,  line = -1.5, outer = TRUE)
...
mtext("Test de similaridad X. variatus", side = 3,  line = -1.5, outer = TRUE)
